import{supabase as m}from"./supabaseClient-BXSct5lo.js";/* empty css              *//* empty css               */import{i as D}from"./layout-Ci9LpN5w.js";import{a as x,b as B}from"./utils-CZwHw4kl.js";import{A as L,B as C}from"./dataService-oGL7foF1.js";import"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/+esm";import"./theme-CYs9TE7o.js";let b=[];async function k(){const{data:t,error:n}=await m.from("manual_payments").select("*, profiles:user_id(full_name, cell_tel_no, identity_number), loan_applications:application_id(loan_number, amount, status)").eq("status","pending").order("created_at",{ascending:!1});if(n){console.warn("[manual-payments]",n.message);return}b=t||[],$()}function $(){const t=document.getElementById("pending-manual-payments");if(!t)return;if(!b.length){t.innerHTML=`
