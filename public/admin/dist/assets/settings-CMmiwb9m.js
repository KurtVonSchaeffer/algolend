import{supabase as f}from"./supabaseClient-BXSct5lo.js";/* empty css              *//* empty css               */import{i as R}from"./layout-Ci9LpN5w.js";import{g as M,u as H,h as j,i as z,j as q,k as O,l as W,m as Y}from"./dataService-oGL7foF1.js";import{e as V,D as g,g as X,p as P,a as Z}from"./theme-CYs9TE7o.js";import"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/+esm";let $="borrower",m=null,L=[],v={...g},s={...g},_=!1,w=!1,G=!1,J=!1;const C=[{key:"primary_color",label:"Primary Color",description:"Used for CTAs, highlights and primary focus states."},{key:"secondary_color",label:"Secondary Color",description:"Used for gradients, hover states and charts."},{key:"tertiary_color",label:"Tertiary Color",description:"Used for gradients and subtle accents."}],K=e=>{switch(e){case"super_admin":return"bg-purple-100 text-purple-700 border-purple-200";case"admin":return"bg-blue-100 text-blue-700 border-blue-200";case"base_admin":return"bg-orange-100 text-orange-700 border-orange-200";default:return"bg-green-50 text-green-700 border-green-200"}},k=e=>{switch(e){case"super_admin":return"SUPER ADMIN";case"admin":return"LOAN MANAGER";case"base_admin":return"LOAN OFFICER";default:return"CLIENT"}},N=(e,t={})=>{const{sizeClass:a="w-10 h-10",textClass:n="text-sm"}=t,o=e.full_name||"U";return e.avatar_url?`<img src="${e.avatar_url}" class="${a} rounded-full object-cover border border-gray-200 shadow-sm" alt="${o}">`:`
  ...
  `,document.head.appendChild(t),ie(),A()}function ie(){const e=document.querySelectorAll(".tab-btn");e.forEach(a=>{a.onclick=()=>{e.forEach(o=>o.classList.remove("active")),a.classList.add("active");const n=a.dataset.tab;n==="profile"?A():n==="security"?ue():n==="users"?U():n==="billing"?pe():n==="system"&&me()}});const t=document.getElementById("role-form");t&&t.addEventListener("submit",async a=>{a.preventDefault();const n=document.getElementById("modal-user-id").value,o=document.getElementById("modal-role-select").value;try{const{error:d}=await H(n,o);if(d)throw new Error(d);i("Role updated successfully","success"),document.getElementById("role-modal").classList.add("hidden"),U()}catch(d){i(d.message,"error")}})}function A(){const e=document.getElementById("tab-content");e.innerHTML=`
    ...
    `,document.getElementById("security-form").addEventListener("submit",async t=>{t.preventDefault();const a=document.getElementById("sec-pass").value,n=document.getElementById("sec-confirm").value;if(a!==n)return i("Passwords do not match","error");if(a.length<6)return i("Password too short (min 6 chars)","error");const{error:o}=await f.auth.updateUser({password:a});o?i(o.message,"error"):(i("Password updated successfully","success"),t.target.reset())})}async function U(){const e=document.getElementById("tab-content");if(e){e.innerHTML=`
